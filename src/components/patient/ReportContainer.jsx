  ...
  const addReport = async () => {
    if (newReportData.diagnostico === null) {
      ...
      const data = {
        ...
        tradMotivo: leng.motivo,
        motivo: newReportData.motivo,
        tradAntecedentes: leng.antecedentes,
        antecedentes: newReportData.antecedentes,
        tradClinica: leng.clinica,
        clinica: newReportData.clinica,
        ...
        tradDescDiagnostico: leng.descripcion,
